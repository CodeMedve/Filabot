...
#define STRING_CONFIG_H_AUTHOR "(CodeMedve, FilaBot)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "FilaBot"
 ...
 * 768 step_rev
 * kerület = d * pi
 * kerület = 220 * 3,14 = 220*3,14 = 690,8
 * 
 * step_mm = step_rev / kerület
 * 
 * step_mm = step_rev / ( d * pi) = 1,11175
 * 
 *                                      
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 1.11 , 1.11, 1.11, 1.11 }
